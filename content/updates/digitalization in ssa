...
<div class="align-center">
  <img src="/digitalization_SSA_1.PNG.png"/>
  <img src="/digitalization_SSA_1.PNG.png"/>
</div>
##Impact


Utilizing a rich set of data ranging from household surveys (High-Frequency Phone Surveys on COVID-19) to spatial datasets such as CoverageRight™ by Ookla® , this study finds that digital connectivity enhances households' resilience to shocks during the pandemic in three areas: market access, employment, and human capital development. Below are some major findings:
